 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const p1=1e3,g1=2,m1=14400*1e3,v1=.5;function Rf(t,e=p1,n=g1){const s=e*Math.pow(n,t),i=Math.round(v1*s*(Math.random()-.5)*2);return Math.min(m1,s+i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $f(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(nv(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Zm(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(iv(e))return"Blackberry";if(rv(e))return"Webos";if(ev(e))return"Safari";if((e.includes("chrome/")||tv(e))&&!e.includes("edge/"))return"Chrome";if(sv(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=t.match(n);if(s?.length===2)return s[1]}return"Other"}function Zm(t=rn()){return/firefox\//i.test(t)}function ev(t=rn()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function tv(t=rn()){return/crios\//i.test(t)}function nv(t=rn()){return/iemobile/i.test(t)}function sv(t=rn()){return/android/i.test(t)}function iv(t=rn()){return/blackberry/i.test(t)}function rv(t=rn()){return/webos/i.test(t)}function Eu(t=rn()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function qE(t=rn()){return Eu(t)&&!!window.navigator?.standalone}function QE(){return i1()&&document.documentMode===10}function ov(t=rn()){return Eu(t)||sv(t)||rv(t)||iv(t)||/windows phone/i.test(t)||nv(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function av(t,e=[]){let n;switch(t){case"Browser":n=$f(rn());break;case"Worker":n=`${$f(rn())}-${t}`;break;default:n=t}const s=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${hr}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cv{constructor(e,n){this.providerId=e,this.signInMethod=n}toJSON(){return ps("not implemented")}_getIdTokenResponse(e){return ps("not implemented")}_linkToIdToken(e,n){return ps("not implemented")}_getReauthenticationResolver(e){return ps("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uT(t,e,n=!1){if(Sn(t.app))return Promise.reject(Hs(t));const s="signIn",i=await uv(t,s,e),r=await tr._fromIdTokenResponse(t,s,i);return n||await t._updateCurrentUser(r.user),r}function hT(t,e,n,s){return _n(t).onIdTokenChanged(e,n,s)}function dT(t,e,n){return _n(t).beforeAuthStateChanged(e,n)}function fT(t){return _n(t).signOut()}const ka="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fv extends hv{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,n){}_removeListener(e,n){}}fv.type="SESSION";const pv=fv;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gv(){return typeof Kn().WorkerGlobalScope<"u"&&typeof Kn().importScripts=="function"}async function AT(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function IT(){return navigator?.serviceWorker?.controller||null}function wT(){return gv()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yv{constructor(e,n,s,i,r=!1){this.auth=e,this.resolver=s,this.user=i,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(s){this.reject(s)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:s,postBody:i,tenantId:r,error:o,type:l}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:s,tenantId:r||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(c))}catch(u){this.reject(u)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return PT;case"linkViaPopup":case"linkViaRedirect":return DT;case"reauthViaPopup":case"reauthViaRedirect":return kT;default:ss(this.auth,"internal-error")}}resolve(e){Is(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Is(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const MT="pendingRedirect",ia=new Map;class OT extends yv{constructor(e,n,s=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,s),this.eventId=null}async execute(){let e=ia.get(this.auth._key());if(!e){try{const s=await VT(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(s)}catch(n){e=()=>Promise.reject(n)}ia.set(this.auth._key(),e)}return this.bypassAuthState||ia.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function VT(t,e){const n=Iv(e),s=Av(t);if(!await s._isAvailable())return!1;const i=await s._get(n)==="true";return await s._remove(n),i}async function LT(t,e){return Av(t)._set(Iv(e),"true")}function BT(t,e){ia.set(t._key(),e)}function Av(t){return gs(t._redirectPersistence)}function Iv(t){return sa(MT,t.config.apiKey,t.name)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wf(t,e,n){return FT(t,e,n)}async function FT(t,e,n){if(Sn(t.app))return Promise.reject(Hs(t));const s=fr(t);Wm(t,e,ol),await s._initializationPromise;const i=bu(s,n);return await LT(i,s),i._openRedirect(s,e,"signInViaRedirect")}async function UT(t,e){return await fr(t)._initializationPromise,wv(t,e,!1)}async function wv(t,e,n=!1){if(Sn(t.app))return Promise.reject(Hs(t));const s=fr(t),i=bu(s,e),o=await new OT(s,i,n).execute();return o&&!n&&(delete o.user._redirectEventId,await s._persistUserIfCurrent(o.user),await s._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $T=600*1e3;class HT{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let n=!1;return this.consumers.forEach(s=>{this.isEventForConsumer(e,s)&&(n=!0,this.sendToConsumer(e,s),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!jT(e)||(this.hasHandledPotentialRedirect=!0,n||(this.queuedRedirectEvent=e,n=!0)),n}sendToConsumer(e,n){if(e.error&&!Ev(e)){const s=e.error.code?.split("auth/")[1]||"internal-error";n.onError(Ln(this.auth,s))}else n.onAuthEvent(e)}isEventForConsumer(e,n){const s=n.eventId===null||!!e.eventId&&e.eventId===n.eventId;return n.filter.includes(e.type)&&s}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=$T&&this.cachedEventUids.clear(),this.cachedEventUids.has(zf(e))}saveEventToCache(e){this.cachedEventUids.add(zf(e)),this.lastProcessedEventTime=Date.now()}}function zf(t){return[t.type,t.eventId,t.sessionId,t.tenantId].filter(e=>e).join("-")}function Ev({type:t,error:e}){return t==="unknown"&&e?.code==="auth/no-auth-event"}function jT(t){switch(t.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Ev(t);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _e(t,e,n){let s="Unexpected state";typeof e=="string"?s=e:n=e,kv(t,s,n)}function kv(t,e,n){let s=`FIRESTORE (${pr}) INTERNAL ASSERTION FAILED: ${e} (ID: ${t.toString(16)})`;if(n!==void 0)try{s+=" CONTEXT: "+JSON.stringify(n)}catch{s+=" CONTEXT: "+n}throw ws(s),new Error(s)}function Ke(t,e,n,s){let i="Unexpected state";typeof n=="string"?i=n:s=n,t||kv(e,i,s)}function Ee(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bt(t,e){const n={typeString:t};return e&&(n.value=e),n}function So(t,e){if(!xv(t))throw new fe(X.INVALID_ARGUMENT,"JSON must be an object");let n;for(const s in e)if(e[s]){const i=e[s].typeString,r="value"in e[s]?{value:e[s].value}:void 0;if(!(s in t)){n=`JSON missing required field: '${s}'`;break}const o=t[s];if(i&&typeof o!==i){n=`JSON field '${s}' must be a ${i}.`;break}if(r!==void 0&&o!==r.value){n=`Expected '${s}' field to equal '${r.value}'`;break}}if(n)throw new fe(X.INVALID_ARGUMENT,n);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nv="";function qC(t){let e="";for(let n=0;n<t.length;n++)e.length>0&&(e=cp(e)),e=QC(t.get(n),e);return cp(e)}function QC(t,e){let n=e;const s=t.length;for(let i=0;i<s;i++){const r=t.charAt(i);switch(r){case"\0":n+="";break;case Nv:n+="";break;default:n+=r}}return n}function cp(t){return t+Nv+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function up(t){let e=0;for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e++;return e}function Si(t,e){for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e(n,t[n])}function Mv(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vv="server_timestamp",Lv="__type__",Bv="__previous_value__",Fv="__local_write_time__";function xu(t){return(t?.mapValue?.fields||{})[Lv]?.stringValue===Vv}function hl(t){const e=t.mapValue.fields[Bv];return xu(e)?hl(e):e}function fo(t){const e=Ys(t.mapValue.fields[Fv].timestampValue);return new dt(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jv{}class Ot extends jv{constructor(e,n,s){super(),this.field=e,this.op=n,this.value=s}static create(e,n,s){return e.isKeyField()?n==="in"||n==="not-in"?this.createKeyFieldInFilter(e,n,s):new eb(e,n,s):n==="array-contains"?new sb(e,s):n==="in"?new ib(e,s):n==="not-in"?new rb(e,s):n==="array-contains-any"?new ob(e,s):new Ot(e,n,s)}static createKeyFieldInFilter(e,n,s){return n==="in"?new tb(e,s):new nb(e,s)}matches(e){const n=e.data.field(this.field);return this.op==="!="?n!==null&&n.nullValue===void 0&&this.matchesComparison(ir(n,this.value)):n!==null&&Xs(this.value)===Xs(n)&&this.matchesComparison(ir(n,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return _e(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class rs extends jv{constructor(e,n){super(),this.filters=e,this.op=n,this.Pe=null}static create(e,n){return new rs(e,n)}matches(e){return Gv(this)?this.filters.find((n=>!n.matches(e)))===void 0:this.filters.find((n=>n.matches(e)))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce(((e,n)=>e.concat(n.getFlattenedFilters())),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function Gv(t){return t.op==="and"}function qv(t){return ZC(t)&&Gv(t)}function ZC(t){for(const e of t.filters)if(e instanceof rs)return!1;return!0}function Lc(t){if(t instanceof Ot)return t.field.canonicalString()+t.op.toString()+rr(t.value);if(qv(t))return t.filters.map((e=>Lc(e))).join(",");{const e=t.filters.map((n=>Lc(n))).join(",");return`${t.op}(${e})`}}function Qv(t,e){return t instanceof Ot?(function(s,i){return i instanceof Ot&&s.op===i.op&&s.field.isEqual(i.field)&&is(s.value,i.value)})(t,e):t instanceof rs?(function(s,i){return i instanceof rs&&s.op===i.op&&s.filters.length===i.filters.length?s.filters.reduce(((r,o,l)=>r&&Qv(o,i.filters[l])),!0):!1})(t,e):void _e(19439)}function Wv(t){return t instanceof Ot?(function(n){return`${n.field.canonicalString()} ${n.op} ${rr(n.value)}`})(t):t instanceof rs?(function(n){return n.op.toString()+" {"+n.getFilters().map(Wv).join(" ,")+"}"})(t):"Filter"}class eb extends Ot{constructor(e,n,s){super(e,n,s),this.key=me.fromName(s.referenceValue)}matches(e){const n=me.comparator(e.key,this.key);return this.matchesComparison(n)}}class tb extends Ot{constructor(e,n){super(e,"in",n),this.keys=zv("in",n)}matches(e){return this.keys.some((n=>n.isEqual(e.key)))}}class nb extends Ot{constructor(e,n){super(e,"not-in",n),this.keys=zv("not-in",n)}matches(e){return!this.keys.some((n=>n.isEqual(e.key)))}}function zv(t,e){return(e.arrayValue?.values||[]).map((n=>me.fromName(n.referenceValue)))}class sb extends Ot{constructor(e,n){super(e,"array-contains",n)}matches(e){const n=e.data.field(this.field);return Nu(n)&&go(n.arrayValue,this.value)}}class ib extends Ot{constructor(e,n){super(e,"in",n)}matches(e){const n=e.data.field(this.field);return n!==null&&go(this.value.arrayValue,n)}}class rb extends Ot{constructor(e,n){super(e,"not-in",n)}matches(e){if(go(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const n=e.data.field(this.field);return n!==null&&n.nullValue===void 0&&!go(this.value.arrayValue,n)}}class ob extends Ot{constructor(e,n){super(e,"array-contains-any",n)}matches(e){const n=e.data.field(this.field);return!(!Nu(n)||!n.arrayValue.values)&&n.arrayValue.values.some((s=>go(this.value.arrayValue,s)))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ri{constructor(e,n){this.mapKeyFn=e,this.equalsFn=n,this.inner={},this.innerSize=0}get(e){const n=this.mapKeyFn(e),s=this.inner[n];if(s!==void 0){for(const[i,r]of s)if(this.equalsFn(i,e))return r}}has(e){return this.get(e)!==void 0}set(e,n){const s=this.mapKeyFn(e),i=this.inner[s];if(i===void 0)return this.inner[s]=[[e,n]],void this.innerSize++;for(let r=0;r<i.length;r++)if(this.equalsFn(i[r][0],e))return void(i[r]=[e,n]);i.push([e,n]),this.innerSize++}delete(e){const n=this.mapKeyFn(e),s=this.inner[n];if(s===void 0)return!1;for(let i=0;i<s.length;i++)if(this.equalsFn(s[i][0],e))return s.length===1?delete this.inner[n]:s.splice(i,1),this.innerSize--,!0;return!1}forEach(e){Si(this.inner,((n,s)=>{for(const[i,r]of s)e(i,r)}))}isEmpty(){return Mv(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fb=new gt(me.comparator);function Es(){return fb}const Jv=new gt(me.comparator);function Or(...t){let e=Jv;for(const n of t)e=e.insert(n.key,n);return e}function Xv(t){let e=Jv;return t.forEach(((n,s)=>e=e.insert(n,s.overlayedDocument))),e}function fi(){return Jr()}function Zv(){return Jr()}function Jr(){return new Ri((t=>t.toString()),((t,e)=>t.isEqual(e)))}const pb=new gt(me.comparator),gb=new Vt(me.comparator);function Le(...t){let e=gb;for(const n of t)e=e.add(n);return e}const mb=new Vt(Ve);function vb(){return mb}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lu(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:xa(e)?"-0":e}}function e_(t){return{integerValue:""+t}}function _b(t,e){return GC(e)?e_(e):Lu(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gl{constructor(){this._=void 0}}function yb(t,e,n){return t instanceof La?(function(i,r){const o={fields:{[Lv]:{stringValue:Vv},[Fv]:{timestampValue:{seconds:i.seconds,nanos:i.nanoseconds}}}};return r&&xu(r)&&(r=hl(r)),r&&(o.fields[Bv]=r),{mapValue:o}})(n,e):t instanceof mo?n_(t,e):t instanceof vo?s_(t,e):(function(i,r){const o=t_(i,r),l=Ap(o)+Ap(i.Ae);return Vc(o)&&Vc(i.Ae)?e_(l):Lu(i.serializer,l)})(t,e)}function Ab(t,e,n){return t instanceof mo?n_(t,e):t instanceof vo?s_(t,e):n}function t_(t,e){return t instanceof Ba?(function(s){return Vc(s)||(function(r){return!!r&&"doubleValue"in r})(s)})(e)?e:{integerValue:0}:null}class La extends gl{}class mo extends gl{constructor(e){super(),this.elements=e}}function n_(t,e){const n=i_(e);for(const s of t.elements)n.some((i=>is(i,s)))||n.push(s);return{arrayValue:{values:n}}}class vo extends gl{constructor(e){super(),this.elements=e}}function s_(t,e){let n=i_(e);for(const s of t.elements)n=n.filter((i=>!is(i,s)));return{arrayValue:{values:n}}}class Ba extends gl{constructor(e,n){super(),this.serializer=e,this.Ae=n}}function Ap(t){return It(t.integerValue||t.doubleValue)}function i_(t){return Nu(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}function Ib(t,e){return t.field.isEqual(e.field)&&(function(s,i){return s instanceof mo&&i instanceof mo||s instanceof vo&&i instanceof vo?sr(s.elements,i.elements,is):s instanceof Ba&&i instanceof Ba?is(s.Ae,i.Ae):s instanceof La&&i instanceof La})(t.transform,e.transform)}class wb{constructor(e,n){this.version=e,this.transformResults=n}}class vs{constructor(e,n){this.updateTime=e,this.exists=n}static none(){return new vs}static exists(e){return new vs(void 0,e)}static updateTime(e){return new vs(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function ca(t,e){return t.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(t.updateTime):t.exists===void 0||t.exists===e.isFoundDocument()}class ml{}function r_(t,e){if(!t.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return t.isNoDocument()?new a_(t.key,vs.none()):new Ro(t.key,t.data,vs.none());{const n=t.data,s=Rn.empty();let i=new Vt(Qt.comparator);for(let r of e.fields)if(!i.has(r)){let o=n.field(r);o===null&&r.length>1&&(r=r.popLast(),o=n.field(r)),o===null?s.delete(r):s.set(r,o),i=i.add(r)}return new Pi(t.key,s,new On(i.toArray()),vs.none())}}function Eb(t,e,n){t instanceof Ro?(function(i,r,o){const l=i.value.clone(),c=wp(i.fieldTransforms,r,o.transformResults);l.setAll(c),r.convertToFoundDocument(o.version,l).setHasCommittedMutations()})(t,e,n):t instanceof Pi?(function(i,r,o){if(!ca(i.precondition,r))return void r.convertToUnknownDocument(o.version);const l=wp(i.fieldTransforms,r,o.transformResults),c=r.data;c.setAll(o_(i)),c.setAll(l),r.convertToFoundDocument(o.version,c).setHasCommittedMutations()})(t,e,n):(function(i,r,o){r.convertToNoDocument(o.version).setHasCommittedMutations()})(0,e,n)}function Xr(t,e,n,s){return t instanceof Ro?(function(r,o,l,c){if(!ca(r.precondition,o))return l;const u=r.value.clone(),d=Ep(r.fieldTransforms,c,o);return u.setAll(d),o.convertToFoundDocument(o.version,u).setHasLocalMutations(),null})(t,e,n,s):t instanceof Pi?(function(r,o,l,c){if(!ca(r.precondition,o))return l;const u=Ep(r.fieldTransforms,c,o),d=o.data;return d.setAll(o_(r)),d.setAll(u),o.convertToFoundDocument(o.version,d).setHasLocalMutations(),l===null?null:l.unionWith(r.fieldMask.fields).unionWith(r.fieldTransforms.map((p=>p.field)))})(t,e,n,s):(function(r,o,l){return ca(r.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):l})(t,e,n)}function Tb(t,e){let n=null;for(const s of t.fieldTransforms){const i=e.data.field(s.field),r=t_(s.transform,i||null);r!=null&&(n===null&&(n=Rn.empty()),n.set(s.field,r))}return n||null}function Ip(t,e){return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&!!(function(s,i){return s===void 0&&i===void 0||!(!s||!i)&&sr(s,i,((r,o)=>Ib(r,o)))})(t.fieldTransforms,e.fieldTransforms)&&(t.type===0?t.value.isEqual(e.value):t.type!==1||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask))}class Ro extends ml{constructor(e,n,s,i=[]){super(),this.key=e,this.value=n,this.precondition=s,this.fieldTransforms=i,this.type=0}getFieldMask(){return null}}class Pi extends ml{constructor(e,n,s,i,r=[]){super(),this.key=e,this.data=n,this.fieldMask=s,this.precondition=i,this.fieldTransforms=r,this.type=1}getFieldMask(){return this.fieldMask}}function o_(t){const e=new Map;return t.fieldMask.fields.forEach((n=>{if(!n.isEmpty()){const s=t.data.field(n);e.set(n,s)}})),e}function wp(t,e,n){const s=new Map;Ke(t.length===n.length,32656,{Re:n.length,Ve:t.length});for(let i=0;i<n.length;i++){const r=t[i],o=r.transform,l=e.data.field(r.field);s.set(r.field,Ab(o,l,n[i]))}return s}function Ep(t,e,n){const s=new Map;for(const i of t){const r=i.transform,o=n.data.field(i.field);s.set(i.field,yb(r,o,e))}return s}class a_ extends ml{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class Cb extends ml{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */vn.DEFAULT_COLLECTION_PERCENTILE=10,vn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,vn.DEFAULT=new vn(__,vn.DEFAULT_COLLECTION_PERCENTILE,vn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),vn.DISABLED=new vn(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jt="WebChannelConnection";class xS extends kS{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,n,s,i,r){const o=qc();return new Promise(((l,c)=>{const u=new Cv;u.setWithCredentials(!0),u.listenOnce(bv.COMPLETE,(()=>{try{switch(u.getLastErrorCode()){case oa.NO_ERROR:const p=u.getResponseJson();ce(Jt,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),l(p);break;case oa.TIMEOUT:ce(Jt,`RPC '${e}' ${o} timed out`),c(new fe(X.DEADLINE_EXCEEDED,"Request time out"));break;case oa.HTTP_ERROR:const m=u.getStatus();if(ce(Jt,`RPC '${e}' ${o} failed with status:`,m,"response text:",u.getResponseText()),m>0){let v=u.getResponseJson();Array.isArray(v)&&(v=v[0]);const T=v?.error;if(T&&T.status&&T.message){const A=(function(k){const F=k.toLowerCase().replace(/_/g,"-");return Object.values(X).indexOf(F)>=0?F:X.UNKNOWN})(T.status);c(new fe(A,T.message))}else c(new fe(X.UNKNOWN,"Server responded with status "+u.getStatus()))}else c(new fe(X.UNAVAILABLE,"Connection failed."));break;default:_e(9055,{l_:e,streamId:o,h_:u.getLastErrorCode(),P_:u.getLastError()})}}finally{ce(Jt,`RPC '${e}' ${o} completed.`)}}));const d=JSON.stringify(i);ce(Jt,`RPC '${e}' ${o} sending request:`,i),u.send(n,"POST",d,s,15)}))}T_(e,n,s){const i=qc(),r=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=Pv(),l=Rv(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(c.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(c.useFetchStreams=!0),this.jo(c.initMessageHeaders,n,s),c.encodeInitMessageHeaders=!0;const d=r.join("");ce(Jt,`Creating RPC '${e}' stream ${i}: ${d}`,c);const p=o.createWebChannel(d,c);this.I_(p);let m=!1,v=!1;const T=new DS({Yo:y=>{v?ce(Jt,`Not sending because RPC '${e}' stream ${i} is closed:`,y):(m||(ce(Jt,`Opening RPC '${e}' stream ${i} transport.`),p.open(),m=!0),ce(Jt,`RPC '${e}' stream ${i} sending:`,y),p.send(y))},Zo:()=>p.close()}),A=(y,k,F)=>{y.listen(k,(U=>{try{F(U)}catch(j){setTimeout((()=>{throw j}),0)}}))};return A(p,Mr.EventType.OPEN,(()=>{v||(ce(Jt,`RPC '${e}' stream ${i} transport opened.`),T.o_())})),A(p,Mr.EventType.CLOSE,(()=>{v||(v=!0,ce(Jt,`RPC '${e}' stream ${i} transport closed`),T.a_(),this.E_(p))})),A(p,Mr.EventType.ERROR,(y=>{v||(v=!0,nr(Jt,`RPC '${e}' stream ${i} transport errored. Name:`,y.name,"Message:",y.message),T.a_(new fe(X.UNAVAILABLE,"The operation could not be completed")))})),A(p,Mr.EventType.MESSAGE,(y=>{if(!v){const k=y.data[0];Ke(!!k,16349);const F=k,U=F?.error||F[0]?.error;if(U){ce(Jt,`RPC '${e}' stream ${i} received error:`,U);const j=U.status;let se=(function(w){const C=Tt[w];if(C!==void 0)return l_(C)})(j),Ie=U.message;se===void 0&&(se=X.INTERNAL,Ie="Unknown error status: "+j+" with message "+U.message),v=!0,T.a_(new fe(se,Ie)),p.close()}else ce(Jt,`RPC '${e}' stream ${i} received:`,k),T.u_(k)}})),A(l,Sv.STAT_EVENT,(y=>{y.stat===Nc.PROXY?ce(Jt,`RPC '${e}' stream ${i} detected buffering proxy`):y.stat===Nc.NOPROXY&&ce(Jt,`RPC '${e}' stream ${i} detected no buffering proxy`)})),setTimeout((()=>{T.__()}),0),T}terminate(){this.c_.forEach((e=>e.close())),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter((n=>n===e))}}function ic(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _l(t){return new Vb(t,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ii="RemoteStore";class BS{constructor(e,n,s,i,r){this.localStore=e,this.datastore=n,this.asyncQueue=s,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=r,this.Aa.Oo((o=>{s.enqueueAndForget((async()=>{ki(this)&&(ce(Ii,"Restarting streams for network reachability change."),await(async function(c){const u=Ee(c);u.Ea.add(4),await ko(u),u.Ra.set("Unknown"),u.Ea.delete(4),await yl(u)})(this))}))})),this.Ra=new LS(s,i)}}async function yl(t){if(ki(t))for(const e of t.da)await e(!0)}async function ko(t){for(const e of t.da)await e(!1)}function T_(t,e){const n=Ee(t);n.Ia.has(e.targetId)||(n.Ia.set(e.targetId,e),zu(n)?Wu(n):vr(n).O_()&&Qu(n,e))}function qu(t,e){const n=Ee(t),s=vr(n);n.Ia.delete(e),s.O_()&&C_(n,e),n.Ia.size===0&&(s.O_()?s.L_():ki(n)&&n.Ra.set("Unknown"))}function Qu(t,e){if(t.Va.Ue(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(Ae.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}vr(t).Y_(e)}function C_(t,e){t.Va.Ue(e),vr(t).Z_(e)}function Wu(t){t.Va=new xb({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),At:e=>t.Ia.get(e)||null,ht:()=>t.datastore.serializer.databaseId}),vr(t).start(),t.Ra.ua()}function zu(t){return ki(t)&&!vr(t).x_()&&t.Ia.size>0}function ki(t){return Ee(t).Ea.size===0}function b_(t){t.Va=void 0}async function FS(t){t.Ra.set("Online")}async function US(t){t.Ia.forEach(((e,n)=>{Qu(t,e)}))}async function $S(t,e){b_(t),zu(t)?(t.Ra.ha(e),Wu(t)):t.Ra.set("Unknown")}async function HS(t,e,n){if(t.Ra.set("Online"),e instanceof u_&&e.state===2&&e.cause)try{await(async function(i,r){const o=r.cause;for(const l of r.targetIds)i.Ia.has(l)&&(await i.remoteSyncer.rejectListen(l,o),i.Ia.delete(l),i.Va.removeTarget(l))})(t,e)}catch(s){ce(Ii,"Failed to remove targets %s: %s ",e.targetIds.join(","),s),await $a(t,s)}else if(e instanceof ua?t.Va.Ze(e):e instanceof c_?t.Va.st(e):t.Va.tt(e),!n.isEqual(Ae.min()))try{const s=await I_(t.localStore);n.compareTo(s)>=0&&await(function(r,o){const l=r.Va.Tt(o);return l.targetChanges.forEach(((c,u)=>{if(c.resumeToken.approximateByteSize()>0){const d=r.Ia.get(u);d&&r.Ia.set(u,d.withResumeToken(c.resumeToken,o))}})),l.targetMismatches.forEach(((c,u)=>{const d=r.Ia.get(c);if(!d)return;r.Ia.set(c,d.withResumeToken(zt.EMPTY_BYTE_STRING,d.snapshotVersion)),C_(r,c);const p=new Bs(d.target,c,u,d.sequenceNumber);Qu(r,p)})),r.remoteSyncer.applyRemoteEvent(l)})(t,n)}catch(s){ce(Ii,"Failed to raise snapshot:",s),await $a(t,s)}}async function $a(t,e,n){if(!mr(e))throw e;t.Ea.add(1),await ko(t),t.Ra.set("Offline"),n||(n=()=>I_(t.localStore)),t.asyncQueue.enqueueRetryable((async()=>{ce(Ii,"Retrying IndexedDB access"),await n(),t.Ea.delete(1),await yl(t)}))}function S_(t,e){return e().catch((n=>$a(t,n,e)))}async function Al(t){const e=Ee(t),n=Zs(e);let s=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:Du;for(;jS(e);)try{const i=await TS(e.localStore,s);if(i===null){e.Ta.length===0&&n.L_();break}s=i.batchId,GS(e,i)}catch(i){await $a(e,i)}R_(e)&&P_(e)}function jS(t){return ki(t)&&t.Ta.length<10}function GS(t,e){t.Ta.push(e);const n=Zs(t);n.O_()&&n.X_&&n.ea(e.mutations)}function R_(t){return ki(t)&&!Zs(t).x_()&&t.Ta.length>0}function P_(t){Zs(t).start()}async function qS(t){Zs(t).ra()}async function QS(t){const e=Zs(t);for(const n of t.Ta)e.ea(n.mutations)}async function WS(t,e,n){const s=t.Ta.shift(),i=Bu.from(s,e,n);await S_(t,(()=>t.remoteSyncer.applySuccessfulWrite(i))),await Al(t)}async function zS(t,e){e&&Zs(t).X_&&await(async function(s,i){if((function(o){return Pb(o)&&o!==X.ABORTED})(i.code)){const r=s.Ta.shift();Zs(s).B_(),await S_(s,(()=>s.remoteSyncer.rejectFailedWrite(r.batchId,i))),await Al(s)}})(t,e),R_(t)&&P_(t)}async function Lp(t,e){const n=Ee(t);n.asyncQueue.verifyOperationInProgress(),ce(Ii,"RemoteStore received new credentials");const s=ki(n);n.Ea.add(3),await ko(n),s&&n.Ra.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.Ea.delete(3),await yl(n)}async function KS(t,e){const n=Ee(t);e?(n.Ea.delete(2),await yl(n)):e||(n.Ea.add(2),await ko(n),n.Ra.set("Unknown"))}function vr(t){return t.ma||(t.ma=(function(n,s,i){const r=Ee(n);return r.sa(),new NS(s,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,i)})(t.datastore,t.asyncQueue,{Xo:FS.bind(null,t),t_:US.bind(null,t),r_:$S.bind(null,t),H_:HS.bind(null,t)}),t.da.push((async e=>{e?(t.ma.B_(),zu(t)?Wu(t):t.Ra.set("Unknown")):(await t.ma.stop(),b_(t))}))),t.ma}function Zs(t){return t.fa||(t.fa=(function(n,s,i){const r=Ee(n);return r.sa(),new MS(s,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,i)})(t.datastore,t.asyncQueue,{Xo:()=>Promise.resolve(),t_:qS.bind(null,t),r_:zS.bind(null,t),ta:QS.bind(null,t),na:WS.bind(null,t)}),t.da.push((async e=>{e?(t.fa.B_(),await Al(t)):(await t.fa.stop(),t.Ta.length>0&&(ce(Ii,`Stopping write stream with ${t.Ta.length} pending writes`),t.Ta=[]))}))),t.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class k_{constructor(e){this.key=e}}class D_{constructor(e){this.key=e}}class sR{constructor(e,n){this.query=e,this.Ya=n,this.Za=null,this.hasCachedResults=!1,this.current=!1,this.Xa=Le(),this.mutatedKeys=Le(),this.eu=Yv(e),this.tu=new Ki(this.eu)}get nu(){return this.Ya}ru(e,n){const s=n?n.iu:new Bp,i=n?n.tu:this.tu;let r=n?n.mutatedKeys:this.mutatedKeys,o=i,l=!1;const c=this.query.limitType==="F"&&i.size===this.query.limit?i.last():null,u=this.query.limitType==="L"&&i.size===this.query.limit?i.first():null;if(e.inorderTraversal(((d,p)=>{const m=i.get(d),v=pl(this.query,p)?p:null,T=!!m&&this.mutatedKeys.has(m.key),A=!!v&&(v.hasLocalMutations||this.mutatedKeys.has(v.key)&&v.hasCommittedMutations);let y=!1;m&&v?m.data.isEqual(v.data)?T!==A&&(s.track({type:3,doc:v}),y=!0):this.su(m,v)||(s.track({type:2,doc:v}),y=!0,(c&&this.eu(v,c)>0||u&&this.eu(v,u)<0)&&(l=!0)):!m&&v?(s.track({type:0,doc:v}),y=!0):m&&!v&&(s.track({type:1,doc:m}),y=!0,(c||u)&&(l=!0)),y&&(v?(o=o.add(v),r=A?r.add(d):r.delete(d)):(o=o.delete(d),r=r.delete(d)))})),this.query.limit!==null)for(;o.size>this.query.limit;){const d=this.query.limitType==="F"?o.last():o.first();o=o.delete(d.key),r=r.delete(d.key),s.track({type:1,doc:d})}return{tu:o,iu:s,Cs:l,mutatedKeys:r}}su(e,n){return e.hasLocalMutations&&n.hasCommittedMutations&&!n.hasLocalMutations}applyChanges(e,n,s,i){const r=this.tu;this.tu=e.tu,this.mutatedKeys=e.mutatedKeys;const o=e.iu.ya();o.sort(((d,p)=>(function(v,T){const A=y=>{switch(y){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return _e(20277,{Rt:y})}};return A(v)-A(T)})(d.type,p.type)||this.eu(d.doc,p.doc))),this.ou(s),i=i??!1;const l=n&&!i?this._u():[],c=this.Xa.size===0&&this.current&&!i?1:0,u=c!==this.Za;return this.Za=c,o.length!==0||u?{snapshot:new ar(this.query,e.tu,r,o,e.mutatedKeys,c===0,u,!1,!!s&&s.resumeToken.approximateByteSize()>0),au:l}:{au:l}}va(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new Bp,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{au:[]}}uu(e){return!this.Ya.has(e)&&!!this.tu.has(e)&&!this.tu.get(e).hasLocalMutations}ou(e){e&&(e.addedDocuments.forEach((n=>this.Ya=this.Ya.add(n))),e.modifiedDocuments.forEach((n=>{})),e.removedDocuments.forEach((n=>this.Ya=this.Ya.delete(n))),this.current=e.current)}_u(){if(!this.current)return[];const e=this.Xa;this.Xa=Le(),this.tu.forEach((s=>{this.uu(s.key)&&(this.Xa=this.Xa.add(s.key))}));const n=[];return e.forEach((s=>{this.Xa.has(s)||n.push(new D_(s))})),this.Xa.forEach((s=>{e.has(s)||n.push(new k_(s))})),n}cu(e){this.Ya=e.Qs,this.Xa=Le();const n=this.ru(e.documents);return this.applyChanges(n,!0)}lu(){return ar.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Za===0,this.hasCachedResults)}}const Xu="SyncEngine";class iR{constructor(e,n,s){this.query=e,this.targetId=n,this.view=s}}class rR{constructor(e){this.key=e,this.hu=!1}}class oR{constructor(e,n,s,i,r,o){this.localStore=e,this.remoteStore=n,this.eventManager=s,this.sharedClientState=i,this.currentUser=r,this.maxConcurrentLimboResolutions=o,this.Pu={},this.Tu=new Ri((l=>Kv(l)),fl),this.Iu=new Map,this.Eu=new Set,this.du=new gt(me.comparator),this.Au=new Map,this.Ru=new $u,this.Vu={},this.mu=new Map,this.fu=or.cr(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function aR(t,e,n=!0){const s=L_(t);let i;const r=s.Tu.get(e);return r?(s.sharedClientState.addLocalQueryTarget(r.targetId),i=r.view.lu()):i=await x_(s,e,n,!0),i}async function lR(t,e){const n=L_(t);await x_(n,e,!0,!1)}async function x_(t,e,n,s){const i=await CS(t.localStore,Yn(e)),r=i.targetId,o=t.sharedClientState.addLocalQueryTarget(r,n);let l;return s&&(l=await cR(t,e,r,o==="current",i.resumeToken)),t.isPrimaryClient&&n&&T_(t.remoteStore,i),l}async function cR(t,e,n,s,i){t.pu=(p,m,v)=>(async function(A,y,k,F){let U=y.view.ru(k);U.Cs&&(U=await xp(A.localStore,y.query,!1).then((({documents:S})=>y.view.ru(S,U))));const j=F&&F.targetChanges.get(y.targetId),se=F&&F.targetMismatches.get(y.targetId)!=null,Ie=y.view.applyChanges(U,A.isPrimaryClient,j,se);return Hp(A,y.targetId,Ie.au),Ie.snapshot})(t,p,m,v);const r=await xp(t.localStore,e,!0),o=new sR(e,r.Qs),l=o.ru(r.documents),c=Po.createSynthesizedTargetChangeForCurrentChange(n,s&&t.onlineState!=="Offline",i),u=o.applyChanges(l,t.isPrimaryClient,c);Hp(t,n,u.au);const d=new iR(e,n,o);return t.Tu.set(e,d),t.Iu.has(n)?t.Iu.get(n).push(e):t.Iu.set(n,[e]),u.snapshot}async function uR(t,e,n){const s=Ee(t),i=s.Tu.get(e),r=s.Iu.get(i.targetId);if(r.length>1)return s.Iu.set(i.targetId,r.filter((o=>!fl(o,e)))),void s.Tu.delete(e);s.isPrimaryClient?(s.sharedClientState.removeLocalQueryTarget(i.targetId),s.sharedClientState.isActiveQueryTarget(i.targetId)||await Gc(s.localStore,i.targetId,!1).then((()=>{s.sharedClientState.clearQueryState(i.targetId),n&&qu(s.remoteStore,i.targetId),Wc(s,i.targetId)})).catch(gr)):(Wc(s,i.targetId),await Gc(s.localStore,i.targetId,!0))}async function hR(t,e){const n=Ee(t),s=n.Tu.get(e),i=n.Iu.get(s.targetId);n.isPrimaryClient&&i.length===1&&(n.sharedClientState.removeLocalQueryTarget(s.targetId),qu(n.remoteStore,s.targetId))}async function dR(t,e,n){const s=yR(t);try{const i=await(function(o,l){const c=Ee(o),u=dt.now(),d=l.reduce(((v,T)=>v.add(T.key)),Le());let p,m;return c.persistence.runTransaction("Locally write mutations","readwrite",(v=>{let T=Es(),A=Le();return c.Ns.getEntries(v,d).next((y=>{T=y,T.forEach(((k,F)=>{F.isValidDocument()||(A=A.add(k))}))})).next((()=>c.localDocuments.getOverlayedDocuments(v,T))).next((y=>{p=y;const k=[];for(const F of l){const U=Tb(F,p.get(F.key).overlayedDocument);U!=null&&k.push(new Pi(F.key,U,Hv(U.value.mapValue),vs.exists(!0)))}return c.mutationQueue.addMutationBatch(v,u,k,l)})).next((y=>{m=y;const k=y.applyToLocalDocumentSet(p,A);return c.documentOverlayCache.saveOverlays(v,y.batchId,k)}))})).then((()=>({batchId:m.batchId,changes:Xv(p)})))})(s.localStore,e);s.sharedClientState.addPendingMutation(i.batchId),(function(o,l,c){let u=o.Vu[o.currentUser.toKey()];u||(u=new gt(Ve)),u=u.insert(l,c),o.Vu[o.currentUser.toKey()]=u})(s,i.batchId,n),await Do(s,i.changes),await Al(s.remoteStore)}catch(i){const r=Yu(i,"Failed to persist write");n.reject(r)}}async function N_(t,e){const n=Ee(t);try{const s=await wS(n.localStore,e);e.targetChanges.forEach(((i,r)=>{const o=n.Au.get(r);o&&(Ke(i.addedDocuments.size+i.modifiedDocuments.size+i.removedDocuments.size<=1,22616),i.addedDocuments.size>0?o.hu=!0:i.modifiedDocuments.size>0?Ke(o.hu,14607):i.removedDocuments.size>0&&(Ke(o.hu,42227),o.hu=!1))})),await Do(n,s,e)}catch(s){await gr(s)}}function $p(t,e,n){const s=Ee(t);if(s.isPrimaryClient&&n===0||!s.isPrimaryClient&&n===1){const i=[];s.Tu.forEach(((r,o)=>{const l=o.view.va(e);l.snapshot&&i.push(l.snapshot)})),(function(o,l){const c=Ee(o);c.onlineState=l;let u=!1;c.queries.forEach(((d,p)=>{for(const m of p.Sa)m.va(l)&&(u=!0)})),u&&Ju(c)})(s.eventManager,e),i.length&&s.Pu.H_(i),s.onlineState=e,s.isPrimaryClient&&s.sharedClientState.setOnlineState(e)}}async function fR(t,e,n){const s=Ee(t);s.sharedClientState.updateQueryState(e,"rejected",n);const i=s.Au.get(e),r=i&&i.key;if(r){let o=new gt(me.comparator);o=o.insert(r,en.newNoDocument(r,Ae.min()));const l=Le().add(r),c=new vl(Ae.min(),new Map,new gt(Ve),o,l);await N_(s,c),s.du=s.du.remove(r),s.Au.delete(e),Zu(s)}else await Gc(s.localStore,e,!1).then((()=>Wc(s,e,n))).catch(gr)}async function pR(t,e){const n=Ee(t),s=e.batch.batchId;try{const i=await IS(n.localStore,e);O_(n,s,null),M_(n,s),n.sharedClientState.updateMutationState(s,"acknowledged"),await Do(n,i)}catch(i){await gr(i)}}async function gR(t,e,n){const s=Ee(t);try{const i=await(function(o,l){const c=Ee(o);return c.persistence.runTransaction("Reject batch","readwrite-primary",(u=>{let d;return c.mutationQueue.lookupMutationBatch(u,l).next((p=>(Ke(p!==null,37113),d=p.keys(),c.mutationQueue.removeMutationBatch(u,p)))).next((()=>c.mutationQueue.performConsistencyCheck(u))).next((()=>c.documentOverlayCache.removeOverlaysForBatchId(u,d,l))).next((()=>c.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(u,d))).next((()=>c.localDocuments.getDocuments(u,d)))}))})(s.localStore,e);O_(s,e,n),M_(s,e),s.sharedClientState.updateMutationState(e,"rejected",n),await Do(s,i)}catch(i){await gr(i)}}function M_(t,e){(t.mu.get(e)||[]).forEach((n=>{n.resolve()})),t.mu.delete(e)}function O_(t,e,n){const s=Ee(t);let i=s.Vu[s.currentUser.toKey()];if(i){const r=i.get(e);r&&(n?r.reject(n):r.resolve(),i=i.remove(e)),s.Vu[s.currentUser.toKey()]=i}}function Wc(t,e,n=null){t.sharedClientState.removeLocalQueryTarget(e);for(const s of t.Iu.get(e))t.Tu.delete(s),n&&t.Pu.yu(s,n);t.Iu.delete(e),t.isPrimaryClient&&t.Ru.jr(e).forEach((s=>{t.Ru.containsKey(s)||V_(t,s)}))}function V_(t,e){t.Eu.delete(e.path.canonicalString());const n=t.du.get(e);n!==null&&(qu(t.remoteStore,n),t.du=t.du.remove(e),t.Au.delete(n),Zu(t))}function Hp(t,e,n){for(const s of n)s instanceof k_?(t.Ru.addReference(s.key,e),mR(t,s)):s instanceof D_?(ce(Xu,"Document no longer in limbo: "+s.key),t.Ru.removeReference(s.key,e),t.Ru.containsKey(s.key)||V_(t,s.key)):_e(19791,{wu:s})}function mR(t,e){const n=e.key,s=n.path.canonicalString();t.du.get(n)||t.Eu.has(s)||(ce(Xu,"New document in limbo: "+n),t.Eu.add(s),Zu(t))}function Zu(t){for(;t.Eu.size>0&&t.du.size<t.maxConcurrentLimboResolutions;){const e=t.Eu.values().next().value;t.Eu.delete(e);const n=new me(pt.fromString(e)),s=t.fu.next();t.Au.set(s,new rR(n)),t.du=t.du.insert(n,s),T_(t.remoteStore,new Bs(Yn(Vu(n.path)),s,"TargetPurposeLimboResolution",cl.ce))}}async function Do(t,e,n){const s=Ee(t),i=[],r=[],o=[];s.Tu.isEmpty()||(s.Tu.forEach(((l,c)=>{o.push(s.pu(c,e,n).then((u=>{if((u||n)&&s.isPrimaryClient){const d=u?!u.fromCache:n?.targetChanges.get(c.targetId)?.current;s.sharedClientState.updateQueryState(c.targetId,d?"current":"not-current")}if(u){i.push(u);const d=ju.As(c.targetId,u);r.push(d)}})))})),await Promise.all(o),s.Pu.H_(i),await(async function(c,u){const d=Ee(c);try{await d.persistence.runTransaction("notifyLocalViewChanges","readwrite",(p=>Y.forEach(u,(m=>Y.forEach(m.Es,(v=>d.persistence.referenceDelegate.addReference(p,m.targetId,v))).next((()=>Y.forEach(m.ds,(v=>d.persistence.referenceDelegate.removeReference(p,m.targetId,v)))))))))}catch(p){if(!mr(p))throw p;ce(Gu,"Failed to update sequence numbers: "+p)}for(const p of u){const m=p.targetId;if(!p.fromCache){const v=d.Ms.get(m),T=v.snapshotVersion,A=v.withLastLimboFreeSnapshotVersion(T);d.Ms=d.Ms.insert(m,A)}}})(s.localStore,r))}async function vR(t,e){const n=Ee(t);if(!n.currentUser.isEqual(e)){ce(Xu,"User change. New user:",e.toKey());const s=await A_(n.localStore,e);n.currentUser=e,(function(r,o){r.mu.forEach((l=>{l.forEach((c=>{c.reject(new fe(X.CANCELLED,o))}))})),r.mu.clear()})(n,"'waitForPendingWrites' promise is rejected due to a user change."),n.sharedClientState.handleUserChange(e,s.removedBatchIds,s.addedBatchIds),await Do(n,s.Ls)}}function _R(t,e){const n=Ee(t),s=n.Au.get(e);if(s&&s.hu)return Le().add(s.key);{let i=Le();const r=n.Iu.get(e);if(!r)return i;for(const o of r){const l=n.Tu.get(o);i=i.unionWith(l.view.nu)}return i}}function L_(t){const e=Ee(t);return e.remoteStore.remoteSyncer.applyRemoteEvent=N_.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=_R.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=fR.bind(null,e),e.Pu.H_=eR.bind(null,e.eventManager),e.Pu.yu=tR.bind(null,e.eventManager),e}function yR(t){const e=Ee(t);return e.remoteStore.remoteSyncer.applySuccessfulWrite=pR.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=gR.bind(null,e),e}class Ha{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=_l(e.databaseInfo.databaseId),this.sharedClientState=this.Du(e),this.persistence=this.Cu(e),await this.persistence.start(),this.localStore=this.vu(e),this.gcScheduler=this.Fu(e,this.localStore),this.indexBackfillerScheduler=this.Mu(e,this.localStore)}Fu(e,n){return null}Mu(e,n){return null}vu(e){return AS(this.persistence,new vS,e.initialUser,this.serializer)}Cu(e){return new y_(Hu.mi,this.serializer)}Du(e){return new SS}async terminate(){this.gcScheduler?.stop(),this.indexBackfillerScheduler?.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Ha.provider={build:()=>new Ha};class AR extends Ha{constructor(e){super(),this.cacheSizeBytes=e}Fu(e,n){Ke(this.persistence.referenceDelegate instanceof Ua,46915);const s=this.persistence.referenceDelegate.garbageCollector;return new nS(s,e.asyncQueue,n)}Cu(e){const n=this.cacheSizeBytes!==void 0?vn.withCacheSize(this.cacheSizeBytes):vn.DEFAULT;return new y_((s=>Ua.mi(s,n)),this.serializer)}}class zc{async initialize(e,n){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(n),this.remoteStore=this.createRemoteStore(n),this.eventManager=this.createEventManager(n),this.syncEngine=this.createSyncEngine(n,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=s=>$p(this.syncEngine,s,1),this.remoteStore.remoteSyncer.handleCredentialChange=vR.bind(null,this.syncEngine),await KS(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return(function(){return new JS})()}createDatastore(e){const n=_l(e.databaseInfo.databaseId),s=(function(r){return new xS(r)})(e.databaseInfo);return(function(r,o,l,c){return new VS(r,o,l,c)})(e.authCredentials,e.appCheckCredentials,s,n)}createRemoteStore(e){return(function(s,i,r,o,l){return new BS(s,i,r,o,l)})(this.localStore,this.datastore,e.asyncQueue,(n=>$p(this.syncEngine,n,0)),(function(){return Op.v()?new Op:new RS})())}createSyncEngine(e,n){return(function(i,r,o,l,c,u,d){const p=new oR(i,r,o,l,c,u);return d&&(p.gu=!0),p})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,n)}async terminate(){await(async function(n){const s=Ee(n);ce(Ii,"RemoteStore shutting down."),s.Ea.add(5),await ko(s),s.Aa.shutdown(),s.Ra.set("Unknown")})(this.remoteStore),this.datastore?.terminate(),this.eventManager?.terminate()}}zc.provider={build:()=>new zc};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kR=/^__.*__$/;class DR{constructor(e,n,s){this.data=e,this.fieldMask=n,this.fieldTransforms=s}toMutation(e,n){return this.fieldMask!==null?new Pi(e,this.data,this.fieldMask,n,this.fieldTransforms):new Ro(e,this.data,n,this.fieldTransforms)}}function j_(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw _e(40011,{Ac:t})}}class rh{constructor(e,n,s,i,r,o){this.settings=e,this.databaseId=n,this.serializer=s,this.ignoreUndefinedProperties=i,r===void 0&&this.Rc(),this.fieldTransforms=r||[],this.fieldMask=o||[]}get path(){return this.settings.path}get Ac(){return this.settings.Ac}Vc(e){return new rh({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}mc(e){const n=this.path?.child(e),s=this.Vc({path:n,fc:!1});return s.gc(e),s}yc(e){const n=this.path?.child(e),s=this.Vc({path:n,fc:!1});return s.Rc(),s}wc(e){return this.Vc({path:void 0,fc:!0})}Sc(e){return ja(e,this.settings.methodName,this.settings.bc||!1,this.path,this.settings.Dc)}contains(e){return this.fieldMask.find((n=>e.isPrefixOf(n)))!==void 0||this.fieldTransforms.find((n=>e.isPrefixOf(n.field)))!==void 0}Rc(){if(this.path)for(let e=0;e<this.path.length;e++)this.gc(this.path.get(e))}gc(e){if(e.length===0)throw this.Sc("Document fields must not be empty");if(j_(this.Ac)&&kR.test(e))throw this.Sc('Document fields cannot begin and end with "__"')}}class xR{constructor(e,n,s){this.databaseId=e,this.ignoreUndefinedProperties=n,this.serializer=s||_l(e)}Cc(e,n,s,i=!1){return new rh({Ac:e,methodName:n,Dc:s,path:Qt.emptyPath(),fc:!1,bc:i},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function NR(t){const e=t._freezeSettings(),n=_l(t._databaseId);return new xR(t._databaseId,!!e.ignoreUndefinedProperties,n)}function MR(t,e,n,s,i,r={}){const o=t.Cc(r.merge||r.mergeFields?2:0,e,n,i);W_("Data must be an object, but it was:",o,s);const l=q_(s,o);let c,u;if(r.merge)c=new On(o.fieldMask),u=o.fieldTransforms;else if(r.mergeFields){const d=[];for(const p of r.mergeFields){const m=OR(e,p,n);if(!o.contains(m))throw new fe(X.INVALID_ARGUMENT,`Field '${m}' is specified in your field mask but missing from your input data.`);LR(d,m)||d.push(m)}c=new On(d),u=o.fieldTransforms.filter((p=>c.covers(p.field)))}else c=null,u=o.fieldTransforms;return new DR(new Rn(l),c,u)}function G_(t,e){if(Q_(t=_n(t)))return W_("Unsupported field value:",e,t),q_(t,e);if(t instanceof H_)return(function(s,i){if(!j_(i.Ac))throw i.Sc(`${s._methodName}() can only be used with update() and set()`);if(!i.path)throw i.Sc(`${s._methodName}() is not currently supported inside arrays`);const r=s._toFieldTransform(i);r&&i.fieldTransforms.push(r)})(t,e),null;if(t===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.fc&&e.Ac!==4)throw e.Sc("Nested arrays are not supported");return(function(s,i){const r=[];let o=0;for(const l of s){let c=G_(l,i.wc(o));c==null&&(c={nullValue:"NULL_VALUE"}),r.push(c),o++}return{arrayValue:{values:r}}})(t,e)}return(function(s,i){if((s=_n(s))===null)return{nullValue:"NULL_VALUE"};if(typeof s=="number")return _b(i.serializer,s);if(typeof s=="boolean")return{booleanValue:s};if(typeof s=="string")return{stringValue:s};if(s instanceof Date){const r=dt.fromDate(s);return{timestampValue:Fa(i.serializer,r)}}if(s instanceof dt){const r=new dt(s.seconds,1e3*Math.floor(s.nanoseconds/1e3));return{timestampValue:Fa(i.serializer,r)}}if(s instanceof Xn)return{geoPointValue:{latitude:s.latitude,longitude:s.longitude}};if(s instanceof Pn)return{bytesValue:h_(i.serializer,s._byteString)};if(s instanceof $t){const r=i.databaseId,o=s.firestore._databaseId;if(!o.isEqual(r))throw i.Sc(`Document reference is for database ${o.projectId}/${o.database} but should be for database ${r.projectId}/${r.database}`);return{referenceValue:Uu(s.firestore._databaseId||i.databaseId,s._key.path)}}if(s instanceof Zn)return(function(o,l){return{mapValue:{fields:{[Uv]:{stringValue:$v},[Ma]:{arrayValue:{values:o.toArray().map((u=>{if(typeof u!="number")throw l.Sc("VectorValues must only contain numeric values.");return Lu(l.serializer,u)}))}}}}}})(s,i);throw i.Sc(`Unsupported field value: ${ku(s)}`)})(t,e)}function q_(t,e){const n={};return Mv(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Si(t,((s,i)=>{const r=G_(i,e.mc(s));r!=null&&(n[s]=r)})),{mapValue:{fields:n}}}function Q_(t){return!(typeof t!="object"||t===null||t instanceof Array||t instanceof Date||t instanceof dt||t instanceof Xn||t instanceof Pn||t instanceof $t||t instanceof H_||t instanceof Zn)}function W_(t,e,n){if(!Q_(n)||!xv(n)){const s=ku(n);throw s==="an object"?e.Sc(t+" a custom object"):e.Sc(t+" "+s)}}function OR(t,e,n){if((e=_n(e))instanceof ih)return e._internalPath;if(typeof e=="string")return z_(t,e);throw ja("Field path arguments must be of type string or ",t,!1,void 0,n)}const VR=new RegExp("[~\\*/\\[\\]]");function z_(t,e,n){if(e.search(VR)>=0)throw ja(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new ih(...e.split("."))._internalPath}catch{throw ja(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}function ja(t,e,n,s,i){const r=s&&!s.isEmpty(),o=i!==void 0;let l=`Function ${e}() called with invalid data`;n&&(l+=" (via `toFirestore()`)"),l+=". ";let c="";return(r||o)&&(c+=" (found",r&&(c+=` in field ${s}`),o&&(c+=` in document ${i}`),c+=")"),new fe(X.INVALID_ARGUMENT,l+t+c)}function LR(t,e){return t.some((n=>n.isEqual(e)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class K_{constructor(e,n,s,i,r){this._firestore=e,this._userDataWriter=n,this._key=s,this._document=i,this._converter=r}get id(){return this._key.path.lastSegment()}get ref(){return new $t(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new BR(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const n=this._document.data.field(Y_("DocumentSnapshot.get",e));if(n!==null)return this._userDataWriter.convertValue(n)}}}class BR extends K_{data(){return super.data()}}function Y_(t,e){return typeof e=="string"?z_(t,e):e instanceof ih?e._internalPath:e._delegate._internalPath}class FR{convertValue(e,n="none"){switch(Xs(e)){case 0:return null;case 1:return e.booleanValue;case 2:return It(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,n);case 5:return e.stringValue;case 6:return this.convertBytes(Js(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,n);case 11:return this.convertObject(e.mapValue,n);case 10:return this.convertVectorValue(e.mapValue);default:throw _e(62114,{value:e})}}convertObject(e,n){return this.convertObjectMap(e.fields,n)}convertObjectMap(e,n="none"){const s={};return Si(e,((i,r)=>{s[i]=this.convertValue(r,n)})),s}convertVectorValue(e){const n=e.fields?.[Ma].arrayValue?.values?.map((s=>It(s.doubleValue)));return new Zn(n)}convertGeoPoint(e){return new Xn(It(e.latitude),It(e.longitude))}convertArray(e,n){return(e.values||[]).map((s=>this.convertValue(s,n)))}convertServerTimestamp(e,n){switch(n){case"previous":const s=hl(e);return s==null?null:this.convertValue(s,n);case"estimate":return this.convertTimestamp(fo(e));default:return null}}convertTimestamp(e){const n=Ys(e);return new dt(n.seconds,n.nanos)}convertDocumentKey(e,n){const s=pt.fromString(e);Ke(v_(s),9688,{name:e});const i=new po(s.get(1),s.get(3)),r=new me(s.popFirst(5));return i.isEqual(n)||ws(`Document ${r} contains a document reference within a different database (${i.projectId}/${i.database}) which is not supported. It will be treated as a reference in the current database (${n.projectId}/${n.database}) instead.`),r}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oh(t){t=uo(t,$t);const e=uo(t.firestore,sh);return bR($_(e),t._key).then((n=>GR(e,t,n)))}Zr._jsonSchemaVersion="firestore/querySnapshot/1.0",Zr._jsonSchema={type:bt("string",Zr._jsonSchemaVersion),bundleSource:bt("string","QuerySnapshot"),bundleName:bt("string"),bundle:bt("string")};class HR extends FR{constructor(e){super(),this.firestore=e}convertBytes(e){return new Pn(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new $t(this.firestore,null,n)}}function Kc(t,e,n){t=uo(t,$t);const s=uo(t.firestore,sh),i=UR(t.converter,e,n);return jR(s,[MR(NR(s),"setDoc",t._key,i,t.converter!==null,n).toMutation(t._key,vs.none())])}function jR(t,e){return(function(s,i){const r=new Gs;return s.asyncQueue.enqueueAndForget((async()=>dR(await TR(s),i,r))),r.promise})($_(t),e)}function GR(t,e,n){const s=n.docs.get(e._key),i=new HR(t);return new vi(t,i,e._key,s,new Lr(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(i){pr=i})(hr),ns(new Fn("firestore",((s,{instanceIdentifier:i,options:r})=>{const o=s.getProvider("app").getImmediate(),l=new sh(new RC(s.getProvider("auth-internal")),new DC(o,s.getProvider("app-check-internal")),(function(u,d){if(!Object.prototype.hasOwnProperty.apply(u.options,["projectId"]))throw new fe(X.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new po(u.options.projectId,d)})(o,i),o);return r={useFetchStreams:n,...r},l._setSettings(r),l}),"PUBLIC").setMultipleInstances(!0)),xn(np,sp,e),xn(np,sp,"esm2020")})();const J_="@firebase/installations",ah="0.6.19";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const X_=1e4,Z_=`w:${ah}`,ey="FIS_v2",qR="https://firebaseinstallations.googleapis.com/v1",QR=3600*1e3,WR="installations",zR="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uh(t,e=!1){let n;const s=await wl(t.appConfig,r=>{if(!fy(r))throw wi.create("not-registered");const o=r.authToken;if(!e&&_P(o))return r;if(o.requestStatus===1)return n=mP(t,e),r;{if(!navigator.onLine)throw wi.create("app-offline");const l=AP(r);return n=vP(t,l),l}});return n?await n:s.authToken}async function mP(t,e){let n=await Jp(t.appConfig);for(;n.authToken.requestStatus===1;)await ay(100),n=await Jp(t.appConfig);const s=n.authToken;return s.requestStatus===0?uh(t,e):s}function Jp(t){return wl(t,e=>{if(!fy(e))throw wi.create("not-registered");const n=e.authToken;return IP(n)?{...e,authToken:{requestStatus:0}}:e})}async function vP(t,e){try{const n=await pP(t,e),s={...e,authToken:n};return await Ga(t.appConfig,s),n}catch(n){if(ty(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await hy(t.appConfig);else{const s={...e,authToken:{requestStatus:0}};await Ga(t.appConfig,s)}throw n}}function fy(t){return t!==void 0&&t.registrationStatus===2}function _P(t){return t.requestStatus===2&&!yP(t)}function yP(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+QR}function AP(t){const e={requestStatus:1,requestTime:Date.now()};return{...t,authToken:e}}function IP(t){return t.requestStatus===1&&t.requestTime+X_<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const py="installations",bP="installations-internal",SP=t=>{const e=t.getProvider("app").getImmediate(),n=CP(e),s=bi(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},RP=t=>{const e=t.getProvider("app").getImmediate(),n=bi(e,py).getImmediate();return{getId:()=>wP(n),getToken:i=>EP(n,i)}};function PP(){ns(new Fn(py,SP,"PUBLIC")),ns(new Fn(bP,RP,"PRIVATE"))}PP();xn(J_,ah);xn(J_,ah,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
