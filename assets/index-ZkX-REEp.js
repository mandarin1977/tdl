...
*/var js,Tv;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(S,I){function C(){}C.prototype=I.prototype,S.F=I.prototype,S.prototype=new C,S.prototype.constructor=S,S.D=function(k,R,N){for(var E=Array(arguments.length-2),st=2;st<arguments.length;st++)E[st-2]=arguments[st];return I.prototype[R].apply(k,E)}}function n(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(s,n),s.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(S,I,C){C||(C=0);const k=Array(16);if(typeof I=="string")for(var R=0;R<16;++R)k[R]=I.charCodeAt(C++)|I.charCodeAt(C++)<<8|I.charCodeAt(C++)<<16|I.charCodeAt(C++)<<24;else for(R=0;R<16;++R)k[R]=I[C++]|I[C++]<<8|I[C++]<<16|I[C++]<<24;I=S.g[0],C=S.g[1],R=S.g[2];let N=S.g[3],E;E=I+(N^C&(R^N))+k[0]+3614090360&4294967295,I=C+(E<<7&4294967295|E>>>25),E=N+(R^I&(C^R))+k[1]+3905402710&4294967295,N=I+(E<<12&4294967295|E>>>20),E=R+(C^N&(I^C))+k[2]+606105819&4294967295,R=N+(E<<17&4294967295|E>>>15),E=C+(I^R&(N^I))+k[3]+3250441966&4294967295,C=R+(E<<22&4294967295|E>>>10),E=I+(N^C&(R^N))+k[4]+4118548399&4294967295,I=C+(E<<7&4294967295|E>>>25),E=N+(R^I&(C^R))+k[5]+1200080426&4294967295,N=I+(E<<12&4294967295|E>>>20),E=R+(C^N&(I^C))+k[6]+2821735955&4294967295,R=N+(E<<17&4294967295|E>>>15),E=C+(I^R&(N^I))+k[7]+4249261313&4294967295,C=R+(E<<22&4294967295|E>>>10),E=I+(N^C&(R^N))+k[8]+1770035416&4294967295,I=C+(E<<7&4294967295|E>>>25),E=N+(R^I&(C^R))+k[9]+2336552879&4294967295,N=I+(E<<12&4294967295|E>>>20),E=R+(C^N&(I^C))+k[10]+4294925233&4294967295,R=N+(E<<17&4294967295|E>>>15),E=C+(I^R&(N^I))+k[11]+2304563134&4294967295,C=R+(E<<22&4294967295|E>>>10),E=I+(N^C&(R^N))+k[12]+1804603682&4294967295,I=C+(E<<7&4294967295|E>>>25),E=N+(R^I&(C^R))+k[13]+4254626195&4294967295,N=I+(E<<12&4294967295|E>>>20),E=R+(C^N&(I^C))+k[14]+2792965006&4294967295,R=N+(E<<17&4294967295|E>>>15),E=C+(I^R&(N^I))+k[15]+1236535329&4294967295,C=R+(E<<22&4294967295|E>>>10),E=I+(R^N&(C^R))+k[1]+4129170786&4294967295,I=C+(E<<5&4294967295|E>>>27),E=N+(C^R&(I^C))+k[6]+3225465664&4294967295,N=I+(E<<9&4294967295|E>>>23),E=R+(I^C&(N^I))+k[11]+643717713&4294967295,R=N+(E<<14&4294967295|E>>>18),E=C+(N^I&(R^N))+k[0]+3921069994&4294967295,C=R+(E<<20&4294967295|E>>>12),E=I+(R^N&(C^R))+k[5]+3593408605&4294967295,I=C+(E<<5&4294967295|E>>>27),E=N+(C^R&(I^C))+k[10]+38016083&4294967295,N=I+(E<<9&4294967295|E>>>23),E=R+(I^C&(N^I))+k[15]+3634488961&4294967295,R=N+(E<<14&4294967295|E>>>18),E=C+(N^I&(R^N))+k[4]+3889429448&4294967295,C=R+(E<<20&4294967295|E>>>12),E=I+(R^N&(C^R))+k[9]+568446438&4294967295,I=C+(E<<5&4294967295|E>>>27),E=N+(C^R&(I^C))+k[14]+3275163606&4294967295,N=I+(E<<9&4294967295|E>>>23),E=R+(I^C&(N^I))+k[3]+4107603335&4294967295,R=N+(E<<14&4294967295|E>>>18),E=C+(N^I&(R^N))+k[8]+1163531501&4294967295,C=R+(E<<20&4294967295|E>>>12),E=I+(R^N&(C^R))+k[13]+2850285829&4294967295,I=C+(E<<5&4294967295|E>>>27),E=N+(C^R&(I^C))+k[2]+4243563512&4294967295,N=I+(E<<9&4294967295|E>>>23),E=R+(I^C&(N^I))+k[7]+1735328473&4294967295,R=N+(E<<14&4294967295|E>>>18),E=C+(N^I&(R^N))+k[12]+2368359562&4294967295,C=R+(E<<20&4294967295|E>>>12),E=I+(C^R^N)+k[5]+4294588738&4294967295,I=C+(E<<4&4294967295|E>>>28),E=N+(I^C^R)+k[8]+2272392833&4294967295,N=I+(E<<11&4294967295|E>>>21),E=R+(N^I^C)+k[11]+1839030562&4294967295,R=N+(E<<16&4294967295|E>>>16),E=C+(R^N^I)+k[14]+4259657740&4294967295,C=R+(E<<23&4294967295|E>>>9),E=I+(C^R^N)+k[1]+2763975236&4294967295,I=C+(E<<4&4294967295|E>>>28),E=N+(I^C^R)+k[4]+1272893353&4294967295,N=I+(E<<11&4294967295|E>>>21),E=R+(N^I^C)+k[7]+4139469664&4294967295,R=N+(E<<16&4294967295|E>>>16),E=C+(R^N^I)+k[10]+3200236656&4294967295,C=R+(E<<23&4294967295|E>>>9),E=I+(C^R^N)+k[13]+681279174&4294967295,I=C+(E<<4&4294967295|E>>>28),E=N+(I^C^R)+k[0]+3936430074&4294967295,N=I+(E<<11&4294967295|E>>>21),E=R+(N^I^C)+k[3]+3572445317&4294967295,R=N+(E<<16&4294967295|E>>>16),E=C+(R^N^I)+k[6]+76029189&4294967295,C=R+(E<<23&4294967295|E>>>9),E=I+(C^R^N)+k[9]+3654602809&4294967295,I=C+(E<<4&4294967295|E>>>28),E=N+(I^C^R)+k[12]+3873151461&4294967295,N=I+(E<<11&4294967295|E>>>21),E=R+(N^I^C)+k[15]+530742520&4294967295,R=N+(E<<16&4294967295|E>>>16),E=C+(R^N^I)+k[2]+3299628645&4294967295,C=R+(E<<23&4294967295|E>>>9),E=I+(R^(C|~N))+k[0]+4096336452&4294967295,I=C+(E<<6&4294967295|E>>>26),E=N+(C^(I|~R))+k[7]+1126891415&4294967295,N=I+(E<<10&4294967295|E>>>22),E=R+(I^(N|~C))+k[14]+2878612391&4294967295,R=N+(E<<15&4294967295|E>>>17),E=C+(N^(R|~I))+k[5]+4237533241&4294967295,C=R+(E<<21&4294967295|E>>>11),E=I+(R^(C|~N))+k[12]+1700485571&4294967295,I=C+(E<<6&4294967295|E>>>26),E=N+(C^(I|~R))+k[3]+2399980690&4294967295,N=I+(E<<10&4294967295|E>>>22),E=R+(I^(N|~C))+k[10]+4293915773&4294967295,R=N+(E<<15&4294967295|E>>>17),E=C+(N^(R|~I))+k[1]+2240044497&4294967295,C=R+(E<<21&4294967295|E>>>11),E=I+(R^(C|~N))+k[8]+1873313359&4294967295,I=C+(E<<6&4294967295|E>>>26),E=N+(C^(I|~R))+k[15]+4264355552&4294967295,N=I+(E<<10&4294967295|E>>>22),E=R+(I^(N|~C))+k[6]+2734768916&4294967295,R=N+(E<<15&4294967295|E>>>17),E=C+(N^(R|~I))+k[13]+1309151649&4294967295,C=R+(E<<21&4294967295|E>>>11),E=I+(R^(C|~N))+k[4]+4149444226&4294967295,I=C+(E<<6&4294967295|E>>>26),E=N+(C^(I|~R))+k[11]+3174756917&4294967295,N=I+(E<<10&4294967295|E>>>22),E=R+(I^(N|~C))+k[2]+718787259&4294967295,R=N+(E<<15&4294967295|E>>>17),E=C+(N^(R|~I))+k[9]+3951481745&4294967295,S.g[0]=S.g[0]+I&4294967295,S.g[1]=S.g[1]+(R+(E<<21&4294967295|E>>>11))&4294967295,S.g[2]=S.g[2]+R&4294967295,S.g[3]=S.g[3]+N&4294967295}s.prototype.v=function(S,I){I===void 0&&(I=S.length);const C=I-this.blockSize,k=this.C;let R=this.h,N=0;for(;N<I;){if(R==0)for(;N<=C;)i(this,S,N),N+=this.blockSize;if(typeof S=="string"){for(;N<I;)if(k[R++]=S.charCodeAt(N++),R==this.blockSize){i(this,k),R=0;break}}else for(;N<I;)if(k[R++]=S[N++],R==this.blockSize){i(this,k),R=0;break}}this.h=R,this.o+=I},s.prototype.A=function(){var S=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);S[0]=128;for(var I=1;I<S.length-8;++I)S[I]=0;I=this.o*8;for(var C=S.length-8;C<S.length;++C)S[C]=I&255,I/=256;for(this.v(S),S=Array(16),I=0,C=0;C<4;++C)for(let k=0;k<32;k+=8)S[I++]=this.g[C]>>>k&255;return S};function r(S,I){var C=l;return Object.prototype.hasOwnProperty.call(C,S)?C[S]:C[S]=I(S)}function o(S,I){this.h=I;const C=[];let k=!0;for(let R=S.length-1;R>=0;R--){const N=S[R]|0;k&&N==I||(C[R]=N,k=!1)}this.g=C}var l={};function c(S){return-128<=S&&S<128?r(S,function(I){return new o([I|0],I<0?-1:0)}):new o([S|0],S<0?-1:0)}function u(S){if(isNaN(S)||!isFinite(S))return p;if(S<0)return y(u(-S));const I=[];let C=1;for(let k=0;S>=C;k++)I[k]=S/C|0,C*=4294967296;return new o(I,0)}function d(S,I){if(S.length==0)throw Error("number format error: empty string");if(I=I||10,I<2||36<I)throw Error("radix out of range: "+I);if(S.charAt(0)=="-")return y(d(S.substring(1),I));if(S.indexOf("-")>=0)throw Error('number format error: interior "-" character');const C=u(Math.pow(I,8));let k=p;for(let N=0;N<S.length;N+=8){var R=Math.min(8,S.length-N);const E=parseInt(S.substring(N,N+R),I);R<8?(R=u(Math.pow(I,R)),k=k.j(R).add(u(E))):(k=k.j(C),k=k.add(u(E)))}return k}var p=c(0),m=c(1),v=c(16777216);t=o.prototype,t.m=function(){if(w(this))return-y(this).m();let S=0,I=1;for(let C=0;C<this.g.length;C++){const k=this.i(C);S+=(k>=0?k:4294967296+k)*I,I*=4294967296}return S},t.toString=function(S){if(S=S||10,S<2||36<S)throw Error("radix out of range: "+S);if(T(this))return"0";if(w(this))return"-"+y(this).toString(S);const I=u(Math.pow(S,6));var C=this;let k="";for(;;){const R=j(C,I).g;C=P(C,R.j(I));let N=((C.g.length>0?C.g[0]:C.h)>>>0).toString(S);if(C=R,T(C))return N+k;for(;N.length<6;)N="0"+N;k=N+k}},t.i=function(S){return S<0?0:S<this.g.length?this.g[S]:this.h};function T(S){if(S.h!=0)return!1;for(let I=0;I<S.g.length;I++)if(S.g[I]!=0)return!1;return!0}function w(S){return S.h==-1}t.l=function(S){return S=P(this,S),w(S)?-1:T(S)?0:1};function y(S){const I=S.g.length,C=[];for(let k=0;k<I;k++)C[k]=~S.g[k];return new o(C,~S.h).add(m)}t.abs=function(){return w(this)?y(this):this},t.add=function(S){const I=Math.max(this.g.length,S.g.length),C=[];let k=0;for(let R=0;R<=I;R++){let N=k+(this.i(R)&65535)+(S.i(R)&65535),E=(N>>>16)+(this.i(R)>>>16)+(S.i(R)>>>16);k=E>>>16,N&=65535,E&=65535,C[R]=E<<16|N}return new o(C,C[C.length-1]&-2147483648?-1:0)};function P(S,I){return S.add(y(I))}t.j=function(S){if(T(this)||T(S))return p;if(w(this))return w(S)?y(this).j(y(S)):y(y(this).j(S));if(w(S))return y(this.j(y(S)));if(this.l(v)<0&&S.l(v)<0)return u(this.m()*S.m());const I=this.g.length+S.g.length,C=[];for(var k=0;k<2*I;k++)C[k]=0;for(k=0;k<this.g.length;k++)for(let R=0;R<S.g.length;R++){const N=this.i(k)>>>16,E=this.i(k)&65535,st=S.i(R)>>>16,_t=S.i(R)&65535;C[2*k+2*R]+=E*_t,F(C,2*k+2*R),C[2*k+2*R+1]+=N*_t,F(C,2*k+2*R+1),C[2*k+2*R+1]+=E*st,F(C,2*k+2*R+1),C[2*k+2*R+2]+=N*st,F(C,2*k+2*R+2)}for(S=0;S<I;S++)C[S]=C[2*S+1]<<16|C[2*S];for(S=I;S<2*I;S++)C[S]=0;return new o(C,0)};function F(S,I){for(;(S[I]&65535)!=S[I];)S[I+1]+=S[I]>>>16,S[I]&=65535,I++}function U(S,I){this.g=S,this.h=I}function j(S,I){if(T(I))throw Error("division by zero");if(T(S))return new U(p,p);if(w(S))return I=j(y(S),I),new U(y(I.g),y(I.h));if(w(I))return I=j(S,y(I)),new U(y(I.g),I.h);if(S.g.length>30){if(w(S)||w(I))throw Error("slowDivide_ only works with positive integers.");for(var C=m,k=I;k.l(S)<=0;)C=se(C),k=se(k);var R=Ie(C,1),N=Ie(k,1);for(k=Ie(k,2),C=Ie(C,2);!T(k);){var E=N.add(k);E.l(S)<=0&&(R=R.add(C),N=E),k=Ie(k,1),C=Ie(C,1)}return I=P(S,R.j(I)),new U(R,I)}for(R=p;S.l(I)>=0;){for(C=Math.max(1,Math.floor(S.m()/I.m())),k=Math.ceil(Math.log(C)/Math.LN2),k=k<=48?1:Math.pow(2,k-48),N=u(C),E=N.j(I);w(E)||E.l(S)>0;)C-=k,N=u(C),E=N.j(I);T(N)&&(N=m),R=R.add(N),S=P(S,E)}return new U(R,S)}t.B=function(S){return j(this,S).h},t.and=function(S){const I=Math.max(this.g.length,S.g.length),C=[];for(let k=0;k<I;k++)C[k]=this.i(k)&S.i(k);return new o(C,this.h&S.h)},t.or=function(S){const I=Math.max(this.g.length,S.g.length),C=[];for(let k=0;k<I;k++)C[k]=this.i(k)|S.i(k);return new o(C,this.h|S.h)},t.xor=function(S){const I=Math.max(this.g.length,S.g.length),C=[];for(let k=0;k<I;k++)C[k]=this.i(k)^S.i(k);return new o(C,this.h^S.h)};function se(S){const I=S.g.length+1,C=[];for(let k=0;k<I;k++)C[k]=S.i(k)<<1|S.i(k-1)>>>31;return new o(C,S.h)}function Ie(S,I){const C=I>>5;I%=32;const k=S.g.length-C,R=[];for(let N=0;N<k;N++)R[N]=I>0?S.i(N+C)>>>I|S.i(N+C+1)<<32-I:S.i(N+C);return new o(R,S.h)}s.prototype.digest=s.prototype.A,s.prototype.reset=s.prototype.u,s.prototype.update=s.prototype.v,Tv=s,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.B,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=u,o.fromString=d,js=o}).apply(typeof tp<"u"?tp:typeof self<"u"?self:typeof window<"u"?window:{});var Qo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jt="WebChannelConnection";class xS extends kS{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,n,s,i,r){const o=qc();return new Promise(((l,c)=>{const u=new Cv;u.setWithCredentials(!0),u.listenOnce(bv.COMPLETE,(()=>{try{switch(u.getLastErrorCode()){case oa.NO_ERROR:const p=u.getResponseJson();ce(Jt,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),l(p);break;case oa.TIMEOUT:ce(Jt,`RPC '${e}' ${o} timed out`),c(new fe(X.DEADLINE_EXCEEDED,"Request time out"));break;case oa.HTTP_ERROR:const m=u.getStatus();if(ce(Jt,`RPC '${e}' ${o} failed with status:`,m,"response text:",u.getResponseText()),m>0){let v=u.getResponseJson();Array.isArray(v)&&(v=v[0]);const T=v?.error;if(T&&T.status&&T.message){const w=(function(P){const F=P.toLowerCase().replace(/_/g,"-");return Object.values(X).indexOf(F)>=0?F:X.UNKNOWN})(T.status);c(new fe(w,T.message))}else c(new fe(X.UNKNOWN,"Server responded with status "+u.getStatus()))}else c(new fe(X.UNAVAILABLE,"Connection failed."));break;default:_e(9055,{l_:e,streamId:o,h_:u.getLastErrorCode(),P_:u.getLastError()})}}finally{ce(Jt,`RPC '${e}' ${o} completed.`)}}));const d=JSON.stringify(i);ce(Jt,`RPC '${e}' ${o} sending request:`,i),u.send(n,"POST",d,s,15)}))}T_(e,n,s){const i=qc(),r=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=Pv(),l=Rv(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(c.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(c.useFetchStreams=!0),this.jo(c.initMessageHeaders,n,s),c.encodeInitMessageHeaders=!0;const d=r.join("");ce(Jt,`Creating RPC '${e}' stream ${i}: ${d}`,c);const p=o.createWebChannel(d,c);this.I_(p);let m=!1,v=!1;const T=new DS({Yo:y=>{v?ce(Jt,`Not sending because RPC '${e}' stream ${i} is closed:`,y):(m||(ce(Jt,`Opening RPC '${e}' stream ${i} transport.`),p.open(),m=!0),ce(Jt,`RPC '${e}' stream ${i} sending:`,y),p.send(y))},Zo:()=>p.close()}),w=(y,P,F)=>{y.listen(P,(U=>{try{F(U)}catch(j){setTimeout((()=>{throw j}),0)}}))};return w(p,Mr.EventType.OPEN,(()=>{v||(ce(Jt,`RPC '${e}' stream ${i} transport opened.`),T.o_())})),w(p,Mr.EventType.CLOSE,(()=>{v||(v=!0,ce(Jt,`RPC '${e}' stream ${i} transport closed`),T.a_(),this.E_(p))})),w(p,Mr.EventType.ERROR,(y=>{v||(v=!0,nr(Jt,`RPC '${e}' stream ${i} transport errored. Name:`,y.name,"Message:",y.message),T.a_(new fe(X.UNAVAILABLE,"The operation could not be completed")))})),w(p,Mr.EventType.MESSAGE,(y=>{if(!v){const P=y.data[0];Ke(!!P,16349);const F=P,U=F?.error||F[0]?.error;if(U){ce(Jt,`RPC '${e}' stream ${i} received error:`,U);const j=U.status;let se=(function(I){const C=Tt[I];if(C!==void 0)return l_(C)})(j),Ie=U.message;se===void 0&&(se=X.INTERNAL,Ie="Unknown error status: "+j+" with message "+U.message),v=!0,T.a_(new fe(se,Ie)),p.close()}else ce(Jt,`RPC '${e}' stream ${i} received:`,P),T.u_(P)}})),w(l,Sv.STAT_EVENT,(y=>{y.stat===Nc.PROXY?ce(Jt,`RPC '${e}' stream ${i} detected buffering proxy`):y.stat===Nc.NOPROXY&&ce(Jt,`RPC '${e}' stream ${i} detected no buffering proxy`)})),setTimeout((()=>{T.__()}),0),T}terminate(){this.c_.forEach((e=>e.close())),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter((n=>n===e))}}function ic(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
