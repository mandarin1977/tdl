 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xw="FirebaseError";class Un extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=Xw,Object.setPrototypeOf(this,Un.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ci.prototype.create)}}class Ci{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?Zw(r,s):"Error",l=`${this.serviceName}: ${o} (${i}).`;return new Un(i,l,s)}}function Zw(t,e){return t.replace(e1,(n,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const e1=/\{\$([^}]+)}/g;function t1(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function Ks(t,e){if(t===e)return!0;const n=Object.keys(t),s=Object.keys(e);for(const i of n){if(!s.includes(i))return!1;const r=t[i],o=e[i];if(Rf(r)&&Rf(o)){if(!Ks(r,o))return!1}else if(r!==o)return!1}for(const i of s)if(!n.includes(i))return!1;return!0}function Rf(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Dn(mE,_E,"app");function qm(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const vE=qm,Qm=new Ci("auth","Firebase",qm());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Co{constructor(e,n){this.shortDelay=e,this.longDelay=n,Is(n>e,"Short delay should be less than long delay!"),this.isMobile=qw()||zw()}get(){return wE()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ki(t,e){return SE(t,"POST","/v1/accounts:signInWithIdp",Eu(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class y_{constructor(e,n,s,i,r=!1){this.auth=e,this.resolver=s,this.user=i,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(s){this.reject(s)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:s,postBody:i,tenantId:r,error:o,type:l}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:s,tenantId:r||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(c))}catch(u){this.reject(u)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return wT;case"linkViaPopup":case"linkViaRedirect":return TT;case"reauthViaPopup":case"reauthViaRedirect":return ET;default:ss(this.auth,"internal-error")}}resolve(e){Is(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Is(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nc="webStorageSupport";class cC{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=f_,this._completeRedirectFn=w_,this._overrideRedirectResult=kT}async _openPopup(e,n,s,i){Is(this.eventManagers[e._key()]?.manager,"_initialize() not called before _openPopup()");const r=await Jf(e,n,s,xc(),i);return sC(e,r,Ru())}async _openRedirect(e,n,s,i){await this._originValidation(e);const r=await Jf(e,n,s,xc(),i);return dT(r),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:i,promise:r}=this.eventManagers[n];return i?Promise.resolve(i):(Is(r,"If manager is not set, promise should be"),r)}const s=this.initAndGetManager(e);return this.eventManagers[n]={promise:s},s.catch(()=>{delete this.eventManagers[n]}),s}async initAndGetManager(e){const n=await JT(e),s=new OT(e);return n.register("authEvent",i=>(ye(i?.authEvent,e,"invalid-auth-event"),{status:s.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=n,s}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(nc,{type:nc},i=>{const r=i?.[0]?.[nc];r!==void 0&&n(!!r),ss(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=FT(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return r_()||Zm()||Cu()}}const uC=cC;var Xf="@firebase/auth",Zf="1.11.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ai=new ll("@firebase/firestore");function Li(){return Ai.logLevel}function ce(t,...e){if(Ai.logLevel<=Oe.DEBUG){const n=e.map(ku);Ai.debug(`Firestore (${mr}): ${t}`,...n)}}function ws(t,...e){if(Ai.logLevel<=Oe.ERROR){const n=e.map(ku);Ai.error(`Firestore (${mr}): ${t}`,...n)}}function rr(t,...e){if(Ai.logLevel<=Oe.WARN){const n=e.map(ku);Ai.warn(`Firestore (${mr}): ${t}`,...n)}}function ku(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ve(t,e,n){let s="Unexpected state";typeof e=="string"?s=e:n=e,k_(t,s,n)}function k_(t,e,n){let s=`FIRESTORE (${mr}) INTERNAL ASSERTION FAILED: ${e} (ID: ${t.toString(16)})`;if(n!==void 0)try{s+=" CONTEXT: "+JSON.stringify(n)}catch{s+=" CONTEXT: "+n}throw ws(s),new Error(s)}function Ke(t,e,n,s){let i="Unexpected state";typeof n=="string"?i=n:s=n,t||k_(e,i,s)}function Ee(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ob=new gt(me.comparator);function Es(){return ob}const J_=new gt(me.comparator);function Lr(...t){let e=J_;for(const n of t)e=e.insert(n.key,n);return e}function X_(t){let e=J_;return t.forEach(((n,s)=>e=e.insert(n,s.overlayedDocument))),e}function fi(){return Zr()}function Z_(){return Zr()}function Zr(){return new Ri((t=>t.toString()),((t,e)=>t.isEqual(e)))}const ab=new gt(me.comparator),lb=new Vt(me.comparator);function Le(...t){let e=lb;for(const n of t)e=e.add(n);return e}const cb=new Vt(Ve);function ub(){return cb}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xb{constructor(){this.changes=new Ri((e=>e.toString()),((e,n)=>e.isEqual(n))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,n){this.assertNotApplied(),this.changes.set(e,en.newInvalidDocument(e).setReadTime(n))}getEntry(e,n){this.assertNotApplied();const s=this.changes.get(n);return s!==void 0?Y.resolve(s):this.getFromCache(e,n)}getEntries(e,n){return this.getAllFromCache(e,n)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jt="WebChannelConnection";class CS extends ES{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,n,s,i,r){const o=Wc();return new Promise(((l,c)=>{const u=new C_;u.setWithCredentials(!0),u.listenOnce(b_.COMPLETE,(()=>{try{switch(u.getLastErrorCode()){case la.NO_ERROR:const p=u.getResponseJson();ce(Jt,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),l(p);break;case la.TIMEOUT:ce(Jt,`RPC '${e}' ${o} timed out`),c(new fe(X.DEADLINE_EXCEEDED,"Request time out"));break;case la.HTTP_ERROR:const m=u.getStatus();if(ce(Jt,`RPC '${e}' ${o} failed with status:`,m,"response text:",u.getResponseText()),m>0){let _=u.getResponseJson();Array.isArray(_)&&(_=_[0]);const E=_?.error;if(E&&E.status&&E.message){const A=(function(x){const F=x.toLowerCase().replace(/_/g,"-");return Object.values(X).indexOf(F)>=0?F:X.UNKNOWN})(E.status);c(new fe(A,E.message))}else c(new fe(X.UNKNOWN,"Server responded with status "+u.getStatus()))}else c(new fe(X.UNAVAILABLE,"Connection failed."));break;default:ve(9055,{l_:e,streamId:o,h_:u.getLastErrorCode(),P_:u.getLastError()})}}finally{ce(Jt,`RPC '${e}' ${o} completed.`)}}));const d=JSON.stringify(i);ce(Jt,`RPC '${e}' ${o} sending request:`,i),u.send(n,"POST",d,s,15)}))}T_(e,n,s){const i=Wc(),r=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=P_(),l=R_(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(c.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(c.useFetchStreams=!0),this.jo(c.initMessageHeaders,n,s),c.encodeInitMessageHeaders=!0;const d=r.join("");ce(Jt,`Creating RPC '${e}' stream ${i}: ${d}`,c);const p=o.createWebChannel(d,c);this.I_(p);let m=!1,_=!1;const E=new TS({Yo:y=>{_?ce(Jt,`Not sending because RPC '${e}' stream ${i} is closed:`,y):(m||(ce(Jt,`Opening RPC '${e}' stream ${i} transport.`),p.open(),m=!0),ce(Jt,`RPC '${e}' stream ${i} sending:`,y),p.send(y))},Zo:()=>p.close()}),A=(y,x,F)=>{y.listen(x,(U=>{try{F(U)}catch(j){setTimeout((()=>{throw j}),0)}}))};return A(p,Vr.EventType.OPEN,(()=>{_||(ce(Jt,`RPC '${e}' stream ${i} transport opened.`),E.o_())})),A(p,Vr.EventType.CLOSE,(()=>{_||(_=!0,ce(Jt,`RPC '${e}' stream ${i} transport closed`),E.a_(),this.E_(p))})),A(p,Vr.EventType.ERROR,(y=>{_||(_=!0,rr(Jt,`RPC '${e}' stream ${i} transport errored. Name:`,y.name,"Message:",y.message),E.a_(new fe(X.UNAVAILABLE,"The operation could not be completed")))})),A(p,Vr.EventType.MESSAGE,(y=>{if(!_){const x=y.data[0];Ke(!!x,16349);const F=x,U=F?.error||F[0]?.error;if(U){ce(Jt,`RPC '${e}' stream ${i} received error:`,U);const j=U.status;let se=(function(w){const C=Tt[w];if(C!==void 0)return lv(C)})(j),Ie=U.message;se===void 0&&(se=X.INTERNAL,Ie="Unknown error status: "+j+" with message "+U.message),_=!0,E.a_(new fe(se,Ie)),p.close()}else ce(Jt,`RPC '${e}' stream ${i} received:`,x),E.u_(x)}})),A(l,S_.STAT_EVENT,(y=>{y.stat===Oc.PROXY?ce(Jt,`RPC '${e}' stream ${i} detected buffering proxy`):y.stat===Oc.NOPROXY&&ce(Jt,`RPC '${e}' stream ${i} detected no buffering proxy`)})),setTimeout((()=>{E.__()}),0),E}terminate(){this.c_.forEach((e=>e.close())),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter((n=>n===e))}}function oc(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ii="RemoteStore";class DS{constructor(e,n,s,i,r){this.localStore=e,this.datastore=n,this.asyncQueue=s,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=r,this.Aa.Oo((o=>{s.enqueueAndForget((async()=>{ki(this)&&(ce(Ii,"Restarting streams for network reachability change."),await(async function(c){const u=Ee(c);u.Ea.add(4),await xo(u),u.Ra.set("Unknown"),u.Ea.delete(4),await Il(u)})(this))}))})),this.Ra=new kS(s,i)}}async function Il(t){if(ki(t))for(const e of t.da)await e(!0)}async function xo(t){for(const e of t.da)await e(!1)}function Tv(t,e){const n=Ee(t);n.Ia.has(e.targetId)||(n.Ia.set(e.targetId,e),Yu(n)?Ku(n):yr(n).O_()&&zu(n,e))}function Wu(t,e){const n=Ee(t),s=yr(n);n.Ia.delete(e),s.O_()&&Cv(n,e),n.Ia.size===0&&(s.O_()?s.L_():ki(n)&&n.Ra.set("Unknown"))}function zu(t,e){if(t.Va.Ue(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(Ae.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}yr(t).Y_(e)}function Cv(t,e){t.Va.Ue(e),yr(t).Z_(e)}function Ku(t){t.Va=new Cb({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),At:e=>t.Ia.get(e)||null,ht:()=>t.datastore.serializer.databaseId}),yr(t).start(),t.Ra.ua()}function Yu(t){return ki(t)&&!yr(t).x_()&&t.Ia.size>0}function ki(t){return Ee(t).Ea.size===0}function bv(t){t.Va=void 0}async function xS(t){t.Ra.set("Online")}async function NS(t){t.Ia.forEach(((e,n)=>{zu(t,e)}))}async function MS(t,e){bv(t),Yu(t)?(t.Ra.ha(e),Ku(t)):t.Ra.set("Unknown")}async function OS(t,e,n){if(t.Ra.set("Online"),e instanceof uv&&e.state===2&&e.cause)try{await(async function(i,r){const o=r.cause;for(const l of r.targetIds)i.Ia.has(l)&&(await i.remoteSyncer.rejectListen(l,o),i.Ia.delete(l),i.Va.removeTarget(l))})(t,e)}catch(s){ce(Ii,"Failed to remove targets %s: %s ",e.targetIds.join(","),s),await ja(t,s)}else if(e instanceof da?t.Va.Ze(e):e instanceof cv?t.Va.st(e):t.Va.tt(e),!n.isEqual(Ae.min()))try{const s=await Iv(t.localStore);n.compareTo(s)>=0&&await(function(r,o){const l=r.Va.Tt(o);return l.targetChanges.forEach(((c,u)=>{if(c.resumeToken.approximateByteSize()>0){const d=r.Ia.get(u);d&&r.Ia.set(u,d.withResumeToken(c.resumeToken,o))}})),l.targetMismatches.forEach(((c,u)=>{const d=r.Ia.get(c);if(!d)return;r.Ia.set(c,d.withResumeToken(zt.EMPTY_BYTE_STRING,d.snapshotVersion)),Cv(r,c);const p=new Bs(d.target,c,u,d.sequenceNumber);zu(r,p)})),r.remoteSyncer.applyRemoteEvent(l)})(t,n)}catch(s){ce(Ii,"Failed to raise snapshot:",s),await ja(t,s)}}async function ja(t,e,n){if(!vr(e))throw e;t.Ea.add(1),await xo(t),t.Ra.set("Offline"),n||(n=()=>Iv(t.localStore)),t.asyncQueue.enqueueRetryable((async()=>{ce(Ii,"Retrying IndexedDB access"),await n(),t.Ea.delete(1),await Il(t)}))}function Sv(t,e){return e().catch((n=>ja(t,n,e)))}async function wl(t){const e=Ee(t),n=ei(e);let s=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:Nu;for(;VS(e);)try{const i=await _S(e.localStore,s);if(i===null){e.Ta.length===0&&n.L_();break}s=i.batchId,LS(e,i)}catch(i){await ja(e,i)}Rv(e)&&Pv(e)}function VS(t){return ki(t)&&t.Ta.length<10}function LS(t,e){t.Ta.push(e);const n=ei(t);n.O_()&&n.X_&&n.ea(e.mutations)}function Rv(t){return ki(t)&&!ei(t).x_()&&t.Ta.length>0}function Pv(t){ei(t).start()}async function BS(t){ei(t).ra()}async function US(t){const e=ei(t);for(const n of t.Ta)e.ea(n.mutations)}async function FS(t,e,n){const s=t.Ta.shift(),i=Fu.from(s,e,n);await Sv(t,(()=>t.remoteSyncer.applySuccessfulWrite(i))),await wl(t)}async function $S(t,e){e&&ei(t).X_&&await(async function(s,i){if((function(o){return wb(o)&&o!==X.ABORTED})(i.code)){const r=s.Ta.shift();ei(s).B_(),await Sv(s,(()=>s.remoteSyncer.rejectFailedWrite(r.batchId,i))),await wl(s)}})(t,e),Rv(t)&&Pv(t)}async function Lp(t,e){const n=Ee(t);n.asyncQueue.verifyOperationInProgress(),ce(Ii,"RemoteStore received new credentials");const s=ki(n);n.Ea.add(3),await xo(n),s&&n.Ra.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.Ea.delete(3),await Il(n)}async function HS(t,e){const n=Ee(t);e?(n.Ea.delete(2),await Il(n)):e||(n.Ea.add(2),await xo(n),n.Ra.set("Unknown"))}function yr(t){return t.ma||(t.ma=(function(n,s,i){const r=Ee(n);return r.sa(),new bS(s,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,i)})(t.datastore,t.asyncQueue,{Xo:xS.bind(null,t),t_:NS.bind(null,t),r_:MS.bind(null,t),H_:OS.bind(null,t)}),t.da.push((async e=>{e?(t.ma.B_(),Yu(t)?Ku(t):t.Ra.set("Unknown")):(await t.ma.stop(),bv(t))}))),t.ma}function ei(t){return t.fa||(t.fa=(function(n,s,i){const r=Ee(n);return r.sa(),new SS(s,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,i)})(t.datastore,t.asyncQueue,{Xo:()=>Promise.resolve(),t_:BS.bind(null,t),r_:$S.bind(null,t),ta:US.bind(null,t),na:FS.bind(null,t)}),t.da.push((async e=>{e?(t.fa.B_(),await wl(t)):(await t.fa.stop(),t.Ta.length>0&&(ce(Ii,`Stopping write stream with ${t.Ta.length} pending writes`),t.Ta=[]))}))),t.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pR{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ou(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ou(this.observer.error,e):ws("Uncaught Error in snapshot listener:",e.toString()))}Nu(){this.muted=!0}Ou(e,n){setTimeout((()=>{this.muted||e(n)}),0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eP="firebase-installations-database",tP=1,Ei="firebase-installations-store";let lc=null;function uh(){return lc||(lc=$m(eP,tP,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Ei)}}})),lc}async function Qa(t,e){const n=El(t),i=(await uh()).transaction(Ei,"readwrite"),r=i.objectStore(Ei),o=await r.get(n);return await r.put(e,n),await i.done,(!o||o.fid!==e.fid)&&cy(t,e.fid),e}async function hy(t){const e=El(t),s=(await uh()).transaction(Ei,"readwrite");await s.objectStore(Ei).delete(e),await s.done}async function Tl(t,e){const n=El(t),i=(await uh()).transaction(Ei,"readwrite"),r=i.objectStore(Ei),o=await r.get(n),l=e(o);return l===void 0?await r.delete(n):await r.put(l,n),await i.done,l&&(!o||o.fid!==l.fid)&&cy(t,l.fid),l}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const py="installations",yP="installations-internal",AP=t=>{const e=t.getProvider("app").getImmediate(),n=vP(e),s=bi(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},IP=t=>{const e=t.getProvider("app").getImmediate(),n=bi(e,py).getImmediate();return{getId:()=>gP(n),getToken:i=>mP(n,i)}};function wP(){ns(new Bn(py,AP,"PUBLIC")),ns(new Bn(yP,IP,"PRIVATE"))}wP();Dn(Jv,ch);Dn(Jv,ch,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
